...
# what is our output?
output = []
outputfile = "output/girlnames2.csv"
...
for country in ["irish", "english"]:
	...
	url = "http://www.20000-names.com/female_" + country + "_names"
	if country == "english":
		listofnames = [""] + ["_0" + str(k) for k in range(2,10)] + ["_" + str(k) for k in range(10,21)]
	else:
		listofnames = ["", "_02"]
