...
# choice of var names
variableNames = ["FirstNameS","LastName","ServiceNumber", "Age", "BirthYear", "BirthTown", "BirthCounty", "BirthCountry", "Regiment", "UnitBattalion","Year"]
rowLength = len(variableNames)
...
# our data input file
linkset = "input/SClinks/merged/SCServiceMerged.csv" 
