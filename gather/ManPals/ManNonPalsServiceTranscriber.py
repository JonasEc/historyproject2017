...
# our data input file
linkset = "input/MCLinks/MCNonPalsMerged.csv" 

# what is our output?
output = []
outputfile = "output/ManNonPalsServiceData"
...
variableNames = ["ID", "FirstName","LastName","ServiceNumber", "Age", "BirthYear", "BirthTown", "BirthCounty", "ResidenceTown", "ResidenceCounty", "ResidenceCountry", "BirthCountry", "Regiment", "UnitBattalion","Year"]
...
############## BUG Fix 
outputframe= outputframe.rename(index=str, columns={'BirthCountry':"ResidenceTown", "ResidenceCountry": "BirthCountry", "ResidenceCounty":"ResidenceCountry","ResidenceTown":"ResidenceCounty"})
