# -*- coding: utf-8 -*-
"""
Created on Sat Aug 26 21:01:50 2017
...
inputdata = "data/SCBaseSampleMerged2.csv" 
...
outputfile = "input/SCLinks/SC1911NewRec" + DataSetName + ".csv"
...
#		url3 = ""
	...
	urllistD = [url00, url0, url1, url40, url4, url5, url6, url7, url8]
	...
	if counter%saveper == 0: 
		outputframe = pd.DataFrame(output, columns=["Links", "ID"])
