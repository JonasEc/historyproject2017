# -*- coding: utf-8 -*-
"""
Created on Tue Aug 29 17:01:19 2017
...
# our data input file
linkset = "input/SC1911Merged2.csv" 

# what is our output?
output = []
outputfile = "output/SC1911/SC1911dataNew"
...
## First: scrape detailed record for the person
	personOutput = scrapeP(datasoup)
	if personOutput == "Drop":
		continue
	else:
		record = [ID] + personOutput
